...
export const ROOM_FEATURED_LIST_REQUEST = "ROOM_FEATURED_LIST_REQUEST";
export const ROOM_FEATURED_LIST_SUCCESS = "ROOM_FEATURED_LIST_SUCCESS";
export const ROOM_FEATURED_LIST_FAIL = "ROOM_FEATURED_LIST_FAIL";